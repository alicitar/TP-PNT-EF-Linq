...
namespace InstitutoIdioma.Migrations
{
    ...
    [Migration("20221107003927_InstitutoIdioma.Context.InstitutoDatabaseContext5")]
    partial class InstitutoIdiomaContextInstitutoDatabaseContext5
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InstitutoIdioma.Models.UsuarioExamen", b =>
                {
                    ...
                    b.HasKey("UsuarioId", "ExamenId");

                    b.HasIndex("ExamenId");

                    b.ToTable("UsuarioExamen");
                });
            ...
            modelBuilder.Entity("InstitutoIdioma.Models.UsuarioExamen", b =>
                {
                    b.HasOne("InstitutoIdioma.Models.Examen", "Examen")
                        .WithMany("UsuariosExamenes")
                        .HasForeignKey("ExamenId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InstitutoIdioma.Models.Usuario", "Usuario")
                        .WithMany("UsuariosExamenes")
